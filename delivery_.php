...
$opt="<select name ='farmer_id' required><option value=0></option>";
...
?>
	...
	<form id="Sale_form" class="form" method="POST" action="delivery_insert.php" enctype="multipart/form-data"> 
